...
class consultas_model{
    ...
    /*Realizamos una consulta de select para obtener todos los registros*/
    public function get_consulta_Select_Comp(){
        $consulta = $this->db->query("Select * from Visitas");
        // Asociamos el resultado obtenido
        while($filas = $consulta->fetch_assoc()){ 
        $this->resultadoC[]=$filas;
        }
        return $this->resultadoC;    //regresamos el valor dentro de la variable resultado
    }
